...
int main (void) {
	...
	test_case("combining two solutions yields an equal solution")
	{
		Solution s = combine(mockGraph, solution, solution);
	...
	test_case("combining a 0s-solution and an 1s-solution produces a solution with half 0-timings and half 1-timings")
	{
		...
		s = combine(mockGraph, zeroesSol, onesSol);

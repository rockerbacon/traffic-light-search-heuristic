...
#define DEFAULT_NUMBER_OF_RUNS 50
#define DEFAULT_MAX_VERTEX_DEGREE 10
#define DEFAULT_CYCLE 20
#define DEFAULT_GRAPH_MODEL GraphModel::ADJACENCY_LIST
#define DEFAULT_NUMBER_OF_PERTURBATIONS 5
#define DEFAULT_HISTORY_SIZE DEFAULT_NUMBER_OF_VERTICES/10
#define DEFAULT_STOP_CRITERIA stop_criteria::numberOfIterationsWithoutImprovement(30)
